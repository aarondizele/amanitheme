...
function lt_setup()
{
    ...
    // Scripts
    wp_enqueue_script("slimjs", '/js/jquery.slim.min.js');
    wp_enqueue_script("popperjs", '/js/popper.min.js');
    wp_enqueue_script("bootstrapjs", '/js/bootstrap.min.js');
    wp_enqueue_script("slickjs", get_theme_file_uri('/js/slick.min.js'), array('jquery'));
    wp_enqueue_script("pacejs", get_theme_file_uri('/js/pace.min.js'));
