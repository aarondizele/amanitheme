                ...
                <div class="row">
                    ...
                    while ($blog_posts->have_posts()) {
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <h5 class="society__first post_category_header_title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h5>
                            <!-- <p class="mt-3 mb-1">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Blanditiis, aut odio repudiandae rerum aperiam deleniti et iste reprehenderit expedita. Neque sapiente dignissimos magni itaque molestiae, amet perferendis ipsum voluptas
                                reprehenderit.
                            </p> -->
                            <div class="post__date"><?php the_time('F j, Y') ?></div>
                        </div>
